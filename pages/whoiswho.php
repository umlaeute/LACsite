...
echo '<p>The picture was taken right after Dave Phillips\' <a href="'.local_url('program','pdb_filterid=27').'">keynote</a> address, not everybody that came to the conference is in this picture. Sorry, we don\'t <em><a href="http://www.gimp.org/" rel="external">gimp</a></em> you in, your next chance will be LAC\'13 at IEM, Graz.</p>';
