...
#    'reg_vinterested', 'reg_vother',
  ...
  $subject='LAC'.LACY.' registration: '.preg_replace('/[^a-zA-Z0-9 ,]/','', $_POST['reg_prename'].' '.$_POST['reg_name']);
  $message='Dear LAC'.LACY.' Organizers,
...
-- 
This mail was generated by http://lac.linuxaudio.org/'.LACY.'/
...
# send email to participant
  $subject='LAC'.LACY.' registration';
  $rcpt=rawurldecode($_POST['reg_email']);

  $message='Dear '.$_POST['reg_prename'].',

Your registration for LAC'.LACY.' has been received. 
